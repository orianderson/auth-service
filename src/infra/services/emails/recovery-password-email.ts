export const recoveryPassword = (name: string, token?: string): string => `
    <!DOCTYPE html>
<html lang="pt-BR">
  <head>
    <meta charset="UTF-8" />
            ...
            <tr>
              <td style="padding: 32px">
                ...
                <p style="margin: 0 0 24px; color: #333333; font-size: 16px">
                  Mantenha sua conta segura, use o código abaixo para
                  recuperar sua senha. Este código é válido por 15 minutos.:
                </p>
